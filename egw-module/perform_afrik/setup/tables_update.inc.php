...
function perform_afrik_upgrade1_003()
{
	$GLOBALS['egw_setup']->oProc->CreateTable('egw_pa_ville',array(
		'fd' => array(
			'id_ville' => array('type' => 'auto','nullable' => False),
			'nom' => array('type' => 'varchar','precision' => '45','nullable' => False)
		),
		'pk' => array('id_ville'),
		'fk' => array(),
	...
	return $GLOBALS['setup_info']['perform_afrik']['currentver'] = '1.004';
}
