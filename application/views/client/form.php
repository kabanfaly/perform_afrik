<input type="hidden" name="id_client" value="<?php echo!isset($id_client) ? '' : $id_client; ?>" />
...
<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" name="nom" value="<?php echo!isset($nom) ? '' : $nom; ?>" class="form-control" id="nom" required placeholder="<?php echo lang('TYPE_CUSTOMER_NAME'); ?>">
    </div>
    <div class="form-group">
        <label for="telephone"><?php echo lang('PHONE'); ?>:</label>
        <input type="text" name="telephone" value="<?php echo!isset($telephone) ? '' : $telephone; ?>"class="form-control" id="telephone" placeholder="<?php echo lang('TYPE_CUSTOMER_PHONE'); ?>">
    </div>
    <div class="form-group">
        <label for="adresse"><?php echo lang('ADDRESS'); ?>:</label>
        <textarea name="adresse" class="form-control" id="adresse" placeholder="<?php echo lang('TYPE_CUSTOMER_ADDRESS'); ?>"><?php echo!isset($adresse) ? '' : $adresse; ?></textarea>
    </div>
    <div class="form-group">
